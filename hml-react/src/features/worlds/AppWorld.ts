import {
  ...
  import { World } from './features/worlds/cucumber';
  ...
  export default class AppWorld implements World {
    ...
    public parameters: WorldParams['parameters'];  public constructor({ attach, parameters }: WorldParams) {
      ...
      this.setRoute = this.setRoute.bind(this);    this.attach = attach;
